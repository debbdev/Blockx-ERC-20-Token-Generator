        ...
        <div class=" row align-items-center justify-content-center">
          <div class="col-xl-8 col-lg-8 col-md-8">
            <div class="section-bg-headline">
              <div class="top-text-title">STAKING INVESTMENT PLATFORM</div>
              <h2>
                Staking <span class="color-text-bold">BlockX token</span>{" "}
                secure own wallet
              </h2>
            </div>
          </div>
                    ...
                    <div class="staking-content">
                      <div class="stack-time">
                        ...
                        <span class="part-stack">
                          Participate investor <span>2130</span>
                        </span>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7">
                    <div class="stack-name ">
                      <div class="stack-money">
                        <div class="plan-money">
                          <ul>
                            <li>
                              <a href="#">
                                Deposit- 100 USD<span> = </span>Payment- 1000
                                CNS
                              </a>
                            </li>
                            <li>
                              <a href="#">
                                Deposit- 200 USD<span> = </span>Payment- 2000
                                CNS
                              </a>
                            </li>
                            <li>
                              <a href="#">
                                Deposit- 300 USD<span> = </span>Payment- 3000
                                CNS
                              </a>
                            </li>
                          </ul>
                      ...
                      <div class="stack-btn coin-btn">
                        <a href="stacking.html">Staking</a>
                      </div>
                    </div>
                  </div>
                </div>
